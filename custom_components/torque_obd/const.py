...
SENSOR_DEFINITIONS: Final = {
    ...
    "kff1280": {
        "name": "Average Fuel Economy (Last Trip)",
        "unit": "mpg",
        "icon": "mdi:gauge",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "kff12b6": {
        "name": "Fuel Injector Duty Cycle Bank 1",
        "unit": PERCENTAGE,
        "icon": "mdi:fuel",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k0105": {
        "name": "Ford Coolant temperature (From TCM)",
        "unit": UnitOfTemperature.CELSIUS,
        "icon": "mdi:coolant-temperature",
        "device_class": SensorDeviceClass.TEMPERATURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k2209cb": {
        "name": "Ford Torque into Torque Converter",
        "unit": "ft-lb",
        "icon": "mdi:engine",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k2209cc": {
        "name": "Ford Injector timing before top dead center",
        "unit": "°",
        "icon": "mdi:fuel",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k2209d4": {
        "name": "Ford Accelerator Pedal Position",
        "unit": PERCENTAGE,
        "icon": "mdi:gauge",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221410": {
        "name": "Ford Fuel Injector Pulse Width",
        "unit": "µs",
        "icon": "mdi:fuel",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221434": {
        "name": "Ford Injector Pressure Regulator Duty Cycle",
        "unit": PERCENTAGE,
        "icon": "mdi:fuel",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221445": {
        "name": "Ford Exhaust Back Pressure",
        "unit": "psi",
        "icon": "mdi:gauge",
        "device_class": SensorDeviceClass.PRESSURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221446": {
        "name": "Ford Injection Control Pressure",
        "unit": "psi",
        "icon": "mdi:gauge",
        "device_class": SensorDeviceClass.PRESSURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k2211b8": {
        "name": "Ford Torque converter slip",
        "unit": "RPM",
        "icon": "mdi:engine",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k2211bd": {
        "name": "Ford Transmission Fluid Temp (Method 3)",
    ...
    "k22160e": {
        "name": "Ford Cylinder 1 Misfire count",
        "unit": None,
    ...
    "k22160f": {
        "name": "Ford Cylinder 2 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221610": {
        "name": "Ford Cylinder 3 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221611": {
        "name": "Ford Cylinder 4 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221612": {
        "name": "Ford Cylinder 5 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221613": {
        "name": "Ford Cylinder 6 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221614": {
        "name": "Ford Cylinder 7 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221615": {
        "name": "Ford Cylinder 8 Misfire count",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221616": {
        "name": "Ford Total number of misfires",
        "unit": None,
        "icon": "mdi:alert-circle",
        "device_class": None,
        "state_class": SensorStateClass.TOTAL_INCREASING,
    ...
    "k221624": {
        "name": "Ford Cylinder head temperature",
        "unit": UnitOfTemperature.FAHRENHEIT,
        "icon": "mdi:thermometer",
        "device_class": SensorDeviceClass.TEMPERATURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221672": {
        "name": "Ford Fuel pump duty cycle",
        "unit": PERCENTAGE,
        "icon": "mdi:fuel",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221674": {
        "name": "Ford Transmission Fluid Temp (Method 1)",
        "unit": UnitOfTemperature.FAHRENHEIT,
        "icon": "mdi:thermometer",
        "device_class": SensorDeviceClass.TEMPERATURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k221685": {
        "name": "Ford Cylinder head temperature (alt)",
        "unit": UnitOfTemperature.FAHRENHEIT,
        "icon": "mdi:thermometer",
        "device_class": SensorDeviceClass.TEMPERATURE,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k223201": {
        "name": "Ford Steering wheel angle",
        "unit": "°",
        "icon": "mdi:steering",
        "device_class": None,
        "state_class": SensorStateClass.MEASUREMENT,
    ...
    "k223a51": {
        "name": "Ford ABS - Lateral acceleration",
        "unit": "g",
